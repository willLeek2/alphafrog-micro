...
public class DomesticDebugController {
    ...
    private final DebugAdminGuard debugAdminGuard;
    private final DomesticDebugQueryService queryService;

    public DomesticDebugController(DebugAdminGuard debugAdminGuard,
                                   DomesticDebugQueryService queryService) {
        this.debugAdminGuard = debugAdminGuard;
