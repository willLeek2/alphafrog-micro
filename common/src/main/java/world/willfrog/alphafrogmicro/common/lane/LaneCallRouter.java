...
public final class LaneCallRouter {
    ...
    public LaneCallBinding bindNewCallByDubboServiceKey(
        ...
        LaneServiceRoute route = table.findByDubboServiceKey(trafficScopeId, dubboServiceKey);
        if (route == null) {
            throw new LaneRouteUnavailableException();
        }
        return route.toBinding();
