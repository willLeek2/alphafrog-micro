...
| `world.willfrog.agent.tools.finance` | FinanceMethodSpec, FinanceMethodSpecCatalog, FinanceMethodResolverCatalog, FinanceMethodResolutionValidator, FinanceMethodSuggestionRenderer, FinanceMethodResolutionSnapshot, FinanceMethodResolutionSink, FinanceMethodKnowledgeCatalog, FinanceMethodTools, FinanceResultModelProjector |
