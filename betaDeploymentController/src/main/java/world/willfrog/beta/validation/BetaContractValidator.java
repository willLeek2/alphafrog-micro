            ...
            for (JsonNode service : deployment.path("services")) {
                ...
                if (candidate.isObject()) {
                    ...
                    if ((service.path("operation").isObject()
                        ...
                        throw new ControllerException("STATE_INVALID", "Candidate identity does not match the current operation");
                }
