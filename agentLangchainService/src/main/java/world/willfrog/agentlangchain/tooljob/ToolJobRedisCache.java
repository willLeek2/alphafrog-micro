...
/**
 * Redis cache and due-index for pending tool jobs.
 * <p>
 * Key layout:
 * <ul>
 ...
 * </ul>
 * The PostgreSQL {@code tool_job_anchor_json} column is the source of truth;
 * this cache is rebuildable from DB anchors.
 */
@Service
